# -*- coding: utf-8 -*-
#
# napari-cellfinder documentation build configuration file, created by
...
project = u'napari-cellfinder'
copyright = u'2015, Adam Tyson'
author = u'Adam Tyson'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-cellfinder Documentation',
     [author], 1)
]
